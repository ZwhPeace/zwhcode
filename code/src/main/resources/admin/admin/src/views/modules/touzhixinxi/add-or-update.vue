<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="联系号码" prop="lianxihaoma">
          <el-input v-model="ruleForm.lianxihaoma" 
              placeholder="联系号码" clearable  :readonly="ro.lianxihaoma"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="联系号码" prop="lianxihaoma">
              <el-input v-model="ruleForm.lianxihaoma" 
                placeholder="联系号码" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="研究生" prop="yanjiusheng">
          <el-input v-model="ruleForm.yanjiusheng" 
              placeholder="研究生" clearable  :readonly="ro.yanjiusheng"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="研究生" prop="yanjiusheng">
              <el-input v-model="ruleForm.yanjiusheng" 
                placeholder="研究生" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="处分" prop="chufen">
          <el-input v-model="ruleForm.chufen" 
              placeholder="处分" clearable  :readonly="ro.chufen"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="处分" prop="chufen">
              <el-input v-model="ruleForm.chufen" 
                placeholder="处分" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="24">  
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.fuzeren = true;
          ...
          if(o=='lianxihaoma'){
            this.ruleForm.lianxihaoma = obj[o];
	    this.ro.lianxihaoma = true;
            continue;
          }
          if(o=='qiyedizhi'){
	    ...
	    this.ro.zhuanye = true;
          ...
          if(o=='yanjiusheng'){
            this.ruleForm.yanjiusheng = obj[o];
	    this.ro.yanjiusheng = true;
            continue;
          }
          if(o=='chufen'){
            this.ruleForm.chufen = obj[o];
	    this.ro.chufen = true;
            continue;
          }
          if(o=='jianli'){
      ...
      this.$http({
		...
		if(json.qiyeguimo!=''&&json.qiyeguimo){
		...
		if(json.lianxihaoma!=''&&json.lianxihaoma){
                this.ruleForm.lianxihaoma = json.lianxihaoma
	    		this.ro.lianxihaoma = true;
		}
		...
		if(json.yanjiusheng!=''&&json.yanjiusheng){
                this.ruleForm.yanjiusheng = json.yanjiusheng
	    		this.ro.yanjiusheng = true;
		}
		if(json.chufen!=''&&json.chufen){
                this.ruleForm.chufen = json.chufen
	    		this.ro.chufen = true;
		}
        } else {
		 ...
		 if(crossrefid && crossuserid) {
			...
			this.$http({ 
				...
				if (data && data.code === 0) { 
					 ...
					 this.$http({
					   url: `touzhixinxi/${!this.ruleForm.id ? "save" : "update"}`,
					   method: "post",
					   data: this.ruleForm
					 }).then(({ data }) => {
					   if (data && data.code === 0) {
						 ...
						 this.parent.touzhixinxiCrossAddOrUpdateFlag = false;
						 this.parent.search();
